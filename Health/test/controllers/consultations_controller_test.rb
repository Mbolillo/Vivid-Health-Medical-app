...
class ConsultationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultation" do
    assert_difference('Consultation.count') do
      post consultations_url, params: { consultation: { content: @consultation.content, patient_id: @consultation.patient_id } }
    end
  ...
  test "should update consultation" do
    patch consultation_url(@consultation), params: { consultation: { content: @consultation.content, patient_id: @consultation.patient_id } }
